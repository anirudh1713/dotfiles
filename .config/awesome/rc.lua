...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "r", function()
		-- awful.spawn.with_shell("$HOME/.config/rofi/launchers/type-1/launcher.sh")
		awful.util.spawn("rofi -show drun")
	end, { description = "run rofi", group = "launcher" }),

	awful.key({ modkey }, "c", function()
		awful.util.spawn("rofi -show window")
	end, { description = "show currently opened windows using rofi", group = "launcher" }),
...
-- External monitor xrandr setup
awful.spawn.with_shell("xrandr --output HDMI-2 --mode 1920x1080 --rate 144.00")
-- xrandr --output eDP --off --set TearFree on --output HDMI-A-0 --primary --mode "1920x1080" --rate 170.00 --set TearFree on --pos 0x0 --rotate normal
